      ...
      {true && (
        <Grid container direction="column" alignItems="center">
          ...
          <Grid item style={{ marginBottom: '7vh' }}>
            <Button aria-label="login" variant="contained" size="large" color="primary" onClick={onClick}>
              ADD BOOK
            </Button>
          </Grid>
          <Grid>
            <Snackbar open={open} message={message} autoHideDuration={2000} onClose={handleClose} />
          </Grid>
        </Grid>
      )}
    </div>
